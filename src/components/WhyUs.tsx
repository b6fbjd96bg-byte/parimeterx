...
const features = [
  { icon: Brain, title: "AI-Powered Platform", description: "Advanced AI continuously scans and identifies vulnerabilities across your entire digital infrastructure." },
  { icon: Users, title: "Expert-Driven Testing", description: "Certified security professionals conduct deep manual testing that automated tools can't match." },
  { icon: Target, title: "Zero-Day & Logic Focus", description: "We uncover unknown vulnerabilities and business logic flaws that attackers exploit." },
  { icon: FileText, title: "Clear & Actionable Reports", description: "Receive detailed reports with prioritized findings and step-by-step remediation guidance." },
  { icon: Clock, title: "Fast Turnaround Time", description: "Get comprehensive security assessments delivered on time without compromising quality." },
  { icon: Zap, title: "Direct Expert Access", description: "Work directly with our security experts who understand your business and threat landscape." },
];
...
const WhyUs = () => {
  ...
  return (
    <section id="why-us" className="py-24 bg-secondary/30 relative overflow-hidden">
      <div className="absolute inset-0 gradient-cyber opacity-50 will-change-transform" style={{ transform: `translateY(${bgParallax}px)` }} />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Why Choose <span className="text-primary text-glow">Parameter X</span>
            </h2>
            ...
            >
              {[
                ...
                <div 
                  ...
                  className={`transition-all duration-500 ${statsAnimation.isVisible ? "opacity-100 scale-100" : "opacity-0 scale-90"}`}
                >
          ...
          <div ref={featuresAnimation.ref} className="grid sm:grid-cols-2 gap-4">
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="h-10 w-10 rounded-lg bg-primary/10 flex items-center justify-center mb-4 group-hover:bg-primary/20 group-hover:scale-110 transition-all duration-300 border border-transparent group-hover:border-primary/20">
